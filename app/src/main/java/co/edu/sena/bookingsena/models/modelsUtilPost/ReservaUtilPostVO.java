 ...
 */
package co.edu.sena.bookingsena.models.modelsUtilPost;

import com.google.gson.annotations.Expose;
import com.google.gson.annotations.SerializedName;

public class ReservaUtilPostVO {
    ...
    @Expose
    private AlojamientoUtilPostVO fkAlojamiento;

    @SerializedName("fkCliente")
    @Expose
    private UsuarioUtilPostVO fkCliente;
    @SerializedName("fkUsuarioChecking")
    @Expose
    private UsuarioUtilPostVO fkUsuarioChecking;
    @SerializedName("fkUsuarioCheckout")
    @Expose
    private UsuarioUtilPostVO fkUsuarioCheckout;

    public ReservaUtilPostVO() {
    }

    public ReservaUtilPostVO( String resFechaRegistro, String resFechaLlegada, String resFechaSalida, String resFechaChecking, String resFechaCheckout, String resEstado, Double resPago, AlojamientoUtilPostVO fkAlojamiento, UsuarioUtilPostVO fkCliente, UsuarioUtilPostVO fkUsuarioChecking, UsuarioUtilPostVO fkUsuarioCheckout) {
    ...
    public AlojamientoUtilPostVO getFkAlojamiento() {
        return fkAlojamiento;
    }

    public void setFkAlojamiento(AlojamientoUtilPostVO fkAlojamiento) {
        this.fkAlojamiento = fkAlojamiento;
    }

    public UsuarioUtilPostVO getFkCliente() {
        return fkCliente;
    }

    public void setFkCliente(UsuarioUtilPostVO fkCliente) {
        this.fkCliente = fkCliente;
    }

    public UsuarioUtilPostVO getFkUsuarioChecking() {
        return fkUsuarioChecking;
    }

    public void setFkUsuarioChecking(UsuarioUtilPostVO fkUsuarioChecking) {
        this.fkUsuarioChecking = fkUsuarioChecking;
    }

    public UsuarioUtilPostVO getFkUsuarioCheckout() {
        return fkUsuarioCheckout;
    }

    public void setFkUsuarioCheckout(UsuarioUtilPostVO fkUsuarioCheckout) {
        this.fkUsuarioCheckout = fkUsuarioCheckout;
    }
}
