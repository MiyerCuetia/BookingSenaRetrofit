...
public class AlojamientoUtilPostVO {
    ...
    public AlojamientoUtilPostVO() {
    }

    public AlojamientoUtilPostVO(Integer aloId) {
        this.aloId = aloId;
    }
    ...
    /*
    public AlojamientoVO(Integer aloId, String aloCodigo, int aloCapacidad, String aloPrecio, String aloDescripcion, Integer fkLugar, Integer fkTipoAlojamiento) {
        this.aloId = aloId;
